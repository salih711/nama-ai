...
export function Reports() {
  return (
    <AppLayout activePage="reports">
      <div className="max-w-[1200px] mx-auto px-10 py-8" style={{ fontFamily: "'Tajawal', 'Cairo', sans-serif" }}>
        
        {/* Header */}
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-2xl font-semibold text-gray-900 tracking-tight">التقارير المالية</h1>
            <p className="text-sm text-gray-500 mt-1">تحليلات ورؤى لحساباتك</p>
          </div>
        ...
        <div className="grid grid-cols-12 gap-8">
          ...
          <div className="col-span-12 lg:col-span-8 space-y-8">
            ...
            <div className="bg-white rounded-xl p-6 border border-gray-100" style={{ boxShadow: '0 1px 3px rgba(0,0,0,0.06), 0 1px 2px rgba(0,0,0,0.04)' }}>
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-[15px] font-semibold text-gray-900">تحليل الإنفاق — المقارنة الشهرية</h2>
                <div className="flex items-center gap-4 text-xs">
                  <div className="flex items-center gap-1.5 text-gray-500">
                    <div className="w-2.5 h-2.5 rounded-sm bg-gray-200"></div> الشهر السابق
                  </div>
                  <div className="flex items-center gap-1.5 text-gray-900 font-medium">
                    <div className="w-2.5 h-2.5 rounded-sm bg-[#00703C]"></div> الشهر الحالي
                  </div>
                </div>
              </div>
              ...
              <div className="h-[240px] w-full flex items-end justify-between pt-4 pb-2 border-b border-gray-100 relative">
                ...
                <div className="absolute inset-0 flex flex-col justify-between pointer-events-none pb-2">
                  {[5000, 4000, 3000, 2000, 1000, 0].map((val, i) => (
                    <div key={i} className="flex items-center w-full">
                      <span className="text-[10px] text-gray-400 w-10 text-right pr-3" dir="ltr">{val === 0 ? '0' : `${val / 1000}k`}</span>
                ...
                <div className="relative z-10 flex flex-1 justify-around items-end h-full px-8 pb-1">
                  <ChartGroup label="السكن" val1={100} val2={100} />
                  <ChartGroup label="الطعام" val1={60} val2={64} />
                  <ChartGroup label="المواصلات" val1={36} val2={30} />
                  <ChartGroup label="التسوق" val1={30} val2={42} />
                  <ChartGroup label="الفواتير" val1={18} val2={16} />
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl border border-gray-100 overflow-hidden" style={{ boxShadow: '0 1px 3px rgba(0,0,0,0.06), 0 1px 2px rgba(0,0,0,0.04)' }}>
              <div className="px-6 py-5 border-b border-gray-50 flex items-center justify-between">
                <h2 className="text-[15px] font-semibold text-gray-900">تفصيل الإنفاق</h2>
                <button className="text-[13px] text-[#00703C] font-medium hover:underline">عرض الكل</button>
              </div>
              <div className="overflow-x-auto">
                <table className="w-full text-right border-collapse">
                  <thead>
                    <tr className="bg-gray-50/50">
                      <th className="px-6 py-3 text-xs font-medium text-gray-500 w-2/5 text-right">الفئة / النسبة</th>
                      <th className="px-6 py-3 text-xs font-medium text-gray-500 text-right">المبلغ</th>
                      <th className="px-6 py-3 text-xs font-medium text-gray-500 text-right">مقارنة بالميزانية</th>
                      <th className="px-6 py-3 text-xs font-medium text-gray-500 text-left">الاتجاه</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-gray-50">
                    <TableRow 
                      icon="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z M9 22V12h6v10"
                      category="السكن والإيجار" 
                      percentage="35%"
                      amount="5,000 ريال" 
                      budget="5,000 ريال"
                      trend="even" 
          ...
          <div className="col-span-12 lg:col-span-4 space-y-8">
            ...
            <div className="bg-[#00703C] rounded-xl p-6 text-white relative overflow-hidden" style={{ boxShadow: '0 4px 12px rgba(0,112,60,0.15)' }}>
              ...
              <div className="absolute top-0 left-0 -ml-16 -mt-16 w-48 h-48 rounded-full bg-white opacity-5 blur-2xl"></div>
              ...
              <div className="flex items-center gap-2.5 mb-5 relative z-10">
                ...
                <h2 className="text-[15px] font-semibold">اقتراحات نماء</h2>
              </div>
              
              <div className="space-y-3 relative z-10">
                <SuggestionCard 
                  text="خفض مصاريف المطاعم بـ 400 ريال سيساعدك في تحقيق هدف الادخار."
                />
                <SuggestionCard 
                  text="أتمتة استثمار 500 ريال شهرياً ستضاعف ثروتك خلال 10 سنوات."
                />
                <SuggestionCard 
                  text="فاتورة الكهرباء لديك أعلى بـ 40% من المتوسط — ننصح بمراجعتها."
                />
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl border border-gray-100 p-6" style={{ boxShadow: '0 1px 3px rgba(0,0,0,0.06), 0 1px 2px rgba(0,0,0,0.04)' }}>
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-[15px] font-semibold text-gray-900">الأهداف المالية</h2>
      ...
      <td className="px-6 py-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-[11px] text-gray-400 mt-0.5" dir="ltr">{percentage} من الإنفاق</div>
          </div>
        </div>
      </td>
      <td className="px-6 py-4">
  ...
  return (
    <div>
      <div className="flex items-end justify-between mb-2">
        ...
        <div className="text-[12px] font-bold text-gray-900" dir="ltr">{percentage}%</div>
      </div>
