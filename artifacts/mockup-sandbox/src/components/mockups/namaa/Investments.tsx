...
export function Investments() {
  return (
    <AppLayout activePage="investments">
      <div className="max-w-6xl mx-auto px-8 py-8 space-y-8 animate-in fade-in duration-500">
        
        {/* Header & Quick Actions */}
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h1 className="text-2xl font-semibold text-gray-900 tracking-tight">Investment Portfolio</h1>
            <p className="text-sm text-gray-500 mt-1">Manage your wealth and track performance.</p>
          </div>
        ...
        <div className="bg-[#00703C]/[0.04] border border-[#00703C]/10 rounded-xl p-4 flex gap-4 items-start shadow-sm">
          ...
          <div className="flex-1">
            <h3 className="text-sm font-semibold text-[#00703C]">Namaa Insight</h3>
            <p className="text-sm text-gray-700 mt-0.5 leading-relaxed">
              Your portfolio is 12% overweight in equities compared to your target allocation. Consider rebalancing or directing new deposits into Sukuk or Cash to reduce your risk exposure.
            </p>
          </div>
          <button className="text-sm font-medium text-[#00703C] hover:text-[#005e32] px-3 py-1.5 rounded-md bg-white border border-[#00703C]/20 hover:bg-[#00703C]/5 transition-colors shadow-sm">
            Review Target
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-white rounded-2xl border border-gray-100 shadow-[0_1px_3px_rgba(0,0,0,0.04),0_1px_2px_rgba(0,0,0,0.02)] overflow-hidden flex flex-col">
            <div className="p-6 pb-2">
              ...
              <div className="flex items-baseline gap-3">
                <h2 className="text-3xl font-semibold text-gray-900 tracking-tight">
                  <span className="text-gray-400 text-xl font-medium mr-1">SAR</span>
                  48,320.00
                </h2>
                <div className="flex items-center gap-1 text-sm font-medium text-[#00703C] bg-[#00703C]/10 px-2 py-0.5 rounded">
            ...
            <div className="h-[200px] w-full mt-4 relative px-6">
              <svg viewBox="0 0 500 200" preserveAspectRatio="none" className="w-full h-full overflow-visible">
                ...
                <text x="0" y="190" fill="#9CA3AF" fontSize="10" fontFamily="sans-serif">Jan</text>
                <text x="100" y="190" fill="#9CA3AF" fontSize="10" fontFamily="sans-serif">Feb</text>
                <text x="200" y="190" fill="#9CA3AF" fontSize="10" fontFamily="sans-serif">Mar</text>
                <text x="300" y="190" fill="#9CA3AF" fontSize="10" fontFamily="sans-serif">Apr</text>
                <text x="400" y="190" fill="#9CA3AF" fontSize="10" fontFamily="sans-serif">May</text>
                <text x="480" y="190" fill="#9CA3AF" fontSize="10" fontFamily="sans-serif">Jun</text>
            ...
            <div className="grid grid-cols-3 divide-x divide-gray-100 border-t border-gray-100 mt-auto bg-gray-50/50">
              <div className="px-6 py-4">
                <div className="text-xs text-gray-500 mb-1">Total Return</div>
                <div className="text-sm font-semibold text-[#00703C]">+12.4%</div>
              </div>
              <div className="px-6 py-4">
                <div className="text-xs text-gray-500 mb-1">Annualized Return</div>
                <div className="text-sm font-semibold text-[#00703C]">+8.2%</div>
              </div>
              <div className="px-6 py-4">
                <div className="text-xs text-gray-500 mb-1">Unrealized Gain</div>
                <div className="text-sm font-semibold text-[#00703C]">+ SAR 5,230</div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-[0_1px_3px_rgba(0,0,0,0.04),0_1px_2px_rgba(0,0,0,0.02)] p-6 flex flex-col">
            <h3 className="text-base font-semibold text-gray-900 mb-6">Asset Allocation</h3>
            ...
            <div className="relative w-40 h-40 mx-auto mb-8">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                <span className="text-xs text-gray-400 font-medium">Assets</span>
                <span className="text-lg font-bold text-gray-900 mt-0.5">4</span>
              </div>
            </div>

            <div className="space-y-3 mt-auto">
              <AllocationRow color="#00703C" label="Stocks" percentage="45%" value="SAR 21,744" />
              <AllocationRow color="#2E9E66" label="Sukuk" percentage="30%" value="SAR 14,496" />
              <AllocationRow color="#85C7A5" label="Real Estate" percentage="15%" value="SAR 7,248" />
              <AllocationRow color="#E5E7EB" label="Cash" percentage="10%" value="SAR 4,832" />
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-[0_1px_3px_rgba(0,0,0,0.04),0_1px_2px_rgba(0,0,0,0.02)] overflow-hidden">
          <div className="px-6 py-5 border-b border-gray-100 flex items-center justify-between">
            <h3 className="text-base font-semibold text-gray-900">Your Positions</h3>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-gray-50/50">
                  ...
                  <th className="px-6 py-3 text-xs font-medium text-gray-500 uppercase tracking-wider text-right">Allocation</th>
                  <th className="px-6 py-3 text-xs font-medium text-gray-500 uppercase tracking-wider text-right">Value (SAR)</th>
                  <th className="px-6 py-3 text-xs font-medium text-gray-500 uppercase tracking-wider text-right">Return</th>
              ...
              <tbody className="divide-y divide-gray-100">
                ...
                <HoldingRow 
                  ...
                  iconBg="bg-[#2E9E66]/10"
                  name="Saudi Sovereign Sukuk Fund"
                  ticker="KSA-SUKUK"
                  allocation="30%"
                  value="14,496.00"
                  returnValue="+4.1%"
